        ...
        if (DocumentsContract.isDocumentUri(context, uri)) {
            ...
            // DownloadsProvider
                ...
                for (String contentUriPrefix : contentUriPrefixesToTry) {
                    try {
                        // note: The value may be a character string. For example, on Huawei 10.0,
                        // the id of the selected file is "MSF :254". As a result, the conversion to Long is abnormal
